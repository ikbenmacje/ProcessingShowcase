...
void draw() 
{
  ...
  w = int(map(patternrow, 0, 64, 10, 600));
  h = int(map(patternrow, 0, 64, 10, 600));

  if (patternnr == 1) {
    if (beat != channel4instr) {
      angle += 0.2;
    }
  } else if (patternnr == 2) {
    if (beat != channel4instr) {
  ...
  fill(255);
  if (channel1note == 143 ) fill(120, 190, 210);
  if (channel1note == 127 ) fill(10, 96, 118);
  else if (channel1note == 160 ) fill(86, 144, 170);
